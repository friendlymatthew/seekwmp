...
export default function Home() {
	...
	const [qualLink, setQualLink] = useState("");
	...
	const TRACKING_ID = "G-D6XFLW0XVS";
			...
			<div className="h-screen flex flex-col justify-between">
					...
					<main className="px-2 mt-4">
						<div className="grid grid-cols-1 place-items-center">
								...
								<section className="mt-12 lg:mt-0 ">
									<ul className="font-medium text-black text-opacity-70">
										...
										<li className="w-11/12 lg:max-w-4xl mt-6 text-lg text-opacity-80 font-medium text-black">
											<div className="text-opacity-100 text-black">
												Snippet:
											</div>
											{query.snippet}
										</li>
							...
							<section className="w-11/12 lg:max-w-4xl">
								<div className="bg-gray-100 rounded-b-md py-4 px-6">
				...
				<div>
					<a
						...
						rel="noreferrer"
					>
						<div className="group items-center flex space-x-4 bg-gray-700 py-4 px-6 mt-8">
							<svg
								xmlns="http://www.w3.org/2000/svg"
